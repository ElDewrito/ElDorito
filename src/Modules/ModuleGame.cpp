...
namespace Modules
{
	ModuleGame::ModuleGame() : ModuleBase("Game")
	{
		...
		VarMenuURL = AddVariableString("MenuURL", "menu_url", "url(string) The URL of the page you want to load inside the menu", eCommandFlagsArchived, "http://no1dead.github.io/");
