...
namespace
{
	...
	std::unordered_map<std::string, uint32_t> weaponIndices = {
		...
		{ "assault_rifle_v2", 0x1581 },
		{ "assault_rifle_v3", 0x1583 },
		{ "assault_rifle_v4", 0x1582 },
		{ "assault_rifle_v6", 0x1584 },
		{ "battle_rifle", 0x157C },
		{ "battle_rifle_v1", 0x1585 },
		{ "battle_rifle_v2", 0x1586 },
		{ "battle_rifle_v3", 0x15BC },
		{ "battle_rifle_v4", 0x15BB },
		{ "battle_rifle_v5", 0x15BD },
		{ "battle_rifle_v6", 0x1587 },
		{ "covenant_carbine", 0x14FE },
		{ "covenant_carbine_v1", 0x15C1 },
		{ "covenant_carbine_v2", 0x15C3 },
		{ "covenant_carbine_v3", 0x15C4 },
		{ "covenant_carbine_v4", 0x15C0 },
		{ "covenant_carbine_v5", 0x15C2 },
		{ "covenant_carbine_v6", 0x1591 },
		{ "dmr", 0x1580 },
		{ "dmr_v1", 0x15BE },
		{ "dmr_v2", 0x1588 },
		{ "dmr_v3", 0x158A },
