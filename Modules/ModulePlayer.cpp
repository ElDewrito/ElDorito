...
namespace Modules
{
	ModulePlayer::ModulePlayer() : ModuleBase("Player")
	{
		...
		AddVariableString("PrivKeyNote", "priv_key_note", "", eCommandFlagsArchived | eCommandFlagsHidden, "The PrivKey below is used to keep your stats safe. Treat it like a password and don't share it with anyone!");
