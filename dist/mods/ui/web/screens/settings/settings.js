...
var settingsToLoad = [
    ...
    ['sTextureResolution','Settings.TextureResolution', 'Texture Resolution', 'Texture Quality affects the resolution and fidelity of the in-game textures. Higher settings use up more VRAM.'],
    ...
    ['sShadowQuality','Settings.ShadowQuality', 'Shadow Quality', 'Shadow Quality determintes the resolution and filtering of all the shadows in the game.'],
    ...
    ['sSFXVolume','Settings.SfxVolume', 'SFX Volume', 'Adjusts the Sound Effects Volume.'],
    ['sMusicVolume','Settings.MusicVolume', 'Music Volume', 'Adjusts the Music Volume'],
    ...
    ['sCameraFOV','Camera.FOV', 'Camera FOV', 'Adjusts the Player Field Of View.'],
    ['cCenteredCrosshair' , 'Camera.Crosshair', 'Centered Crosshair', 'Centers the Crosshair.'], 
    ['cHideHUD', 'Camera.HideHUD', 'Hide HUD', 'Hides the Player Hud.'], 
    ['inputRaw','Input.RawInput', 'Use Raw Input', 'Enables/Disables RawInput.'],  
    ...
    ['gExpandScoreboard','Game.ExpandedScoreboard', 'Always Expand Scoreboard', 'Specifies whether to Always Expand the Scoreboard.'], 
    ['invertLook','Input.ControllerInvertY', 'Invert Look', 'Desc'], 
    ['gHideChat','Game.HideChat', 'Hide Chat', 'Toggles whether to Hide the Game Chat.'], 
    ['gSuppressJuggling','Game.SuppressJuggling', 'Suppress Juggling Announcer Spam', 'Supresses the Audio spam from Juggling.'], 
    ['wOffsetConfig','Weapon.JSON.File', 'Viewmodel Config', 'Specifies which VIewmodel Config to use.'],
    ...
    ['iDisableSprint','Input.ToggleSprint', 'Toggle Sprint', 'Enables or Disables Sprint.'],
    ...
    ['vPTTEnable','VoIP.PTT_Enabled', 'Push To Talk', 'Toggles Push to Talk.'],
    ...
    ['tAgressiveAudioDiscard', 'Tweaks.AggressiveAudioDiscarding', 'Aggressive Audio Discarding', 'Prioritizies gun sounds over others to make audio cutoff less notable.'], 
    ['tDisableFog', 'Tweaks.DisableReactorFog', 'Reacthor', 'Removes some of the fog on Ractor which causes FPS drops indoors.'], 
    ...
    ['tReachFrags','Tweaks.ReachStyleFrags', 'Reach Style Frags', 'Give tossed grenades the orangey-yellow tail ala Halo: Reach.'],
    ['tIntelBloomPatch','Tweaks.IntelBloomPatch', 'Bloom Patch', 'Fixes extreme brightness on sunny maps.'],
    ['sAudioDevice','Settings.AudioOutputDevice', 'Audio Device', 'Specifies what Audio Device the game should use.'],
