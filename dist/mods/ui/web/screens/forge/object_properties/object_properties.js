...
var objectPropertyGridData = {
	...
	meta: {
		...
		team_affiliation: [
			...
			{name: 'Red Team', value: 0},
			{name: 'Blue Team', value: 1},
			{name: 'Green Team', value: 2},
			{name: 'Orange Team', value: 3},
			{name: 'Purple Team', value: 4},
			{name: 'Gold Team', value: 5},
			{name: 'Brown Team', value: 6},
			{name: 'Pink Team', value: 7},
		],
		shape_type: [
			{name: 'Sphere', value: 1},
